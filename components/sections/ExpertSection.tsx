  ...
  return (
    <section className="py-16 px-4 bg-white antialiased">
      <div className="max-w-[500px] mx-auto">
        ...
        <h2 className="text-3xl font-black uppercase italic text-center leading-tight mb-12 tracking-tighter">
          Découvrez pourquoi <span className="text-[#FF6B00]">les experts recommandent</span> Stepprs
        </h2>
        ...
        <div className="flex flex-col rounded-[2.5rem] overflow-hidden bg-[#F8F8F8] shadow-sm border border-stone-100">
          ...
          <div className="p-8 pt-10 text-center space-y-5">
            ...
            <p className="text-sm font-medium text-stone-500 leading-relaxed italic">
              "En tant que podologue forte d'une longue expérience dans le traitement de pathologies telles que les pieds plats et la fasciite plantaire, je recommande les semelles Stepprs. Leur conception unique offre un soutien ciblé à la voûte plantaire, contribuant à une répartition uniforme de la pression."
            </p>
